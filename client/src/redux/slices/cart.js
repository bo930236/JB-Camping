...
export const cartSlice = createSlice({
  ...
  reducers: {
    ...
    // The if-else logic in this code is used to determine whether the item being added to the cart already exists. If it exists, its information is updated; if not, the item is added to the cart.
    // payload is an object representing the product to be added to the shopping cart, which contains information of a single item only.
