...
const ProfileScreen = () => {
  ...
  useEffect(() => {
    if (updateSuccess) {
      toast({ description: 'Profile saved.', duration: 1000, status: 'success', isClosable: true });
                ...
                <Stack spacing='6' as='form' onSubmit={formik.handleSubmit}>
                  ...
                  <Stack spacing='5'>
                    <FormControl>
                      ...
                      <TextField type='text' name='email' placeholder='email@example.com' label='Email' />
              ...
              <Card>
                ...
                <CardBody>
                  <Stack divider={<StackDivider />} spacing='4'>
                    <Box pt='2' fontSize='sm' align='center'>
